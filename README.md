...
> 20 anos, cursando GTI na Unicid (São Paulo) — buscando minha primeira oportunidade CLT/ESTÁGIO como desenvolvedor backend.
...
- 🔗 Desenvolvimento de **APIs REST** com autenticação, validação e tratamento de erros
...
> API REST desenvolvida com Python e Flask para gerenciamento de escalas, equipes e turnos em ambiente hospitalar.

- **Tecnologias:** Python, Flask, SQLite, SQLAlchemy ORM
- **Arquitetura:** Models, Services e Routes
- **Funcionalidades:** gerenciamento de turnos hospitalares, controle de equipes e aplicação de regras de negócio para rotinas administrativas
- **Em desenvolvimento:** autenticação JWT e migração para MySQL
...
Disponível para oportunidades CLT ou Estágio na área de desenvolvimento backend.
